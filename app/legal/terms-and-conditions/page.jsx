const TermsAndConditions = () => {
  return (
    <div className="container leading-20 mb-8">
      <h1 className="text-4xl font-bold text-center my-8">
        Terms and Conditions for Ekoe
      </h1>

      <p className="mb-2">
        These terms and conditions outline the rules and regulations for the use
        of Ekoebrand Clothing&apos;s Website, located at https://ekoe.vercel.app.
      </p>

      <p className="mb-2">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Ekoebrand if you do not agree to take all
      ...
      <p className="mb-2">
        ...
        ke. Any use of the above terminology or other words in the singular,
        plural, capitalization and/or he/she or they, are taken as
        interchangeable and therefore as referring to same.
      </p>

      <h3 className="text-center text-lg font-bold">Cookies</h3>

      <p className="mb-2">
        We employ the use of cookies. By accessing Ekoe, you agreed to use
        cookies in agreement with the Ekoe Clothing&apos;s Privacy Policy.{" "}
      </p>
      ...
      <h3 className="text-center text-lg font-bold">License</h3>

      <p className="mb-2">
        Unless otherwise stated, Ekoe Clothing and/or its licensors own the
        intellectual property rights for all material on Ekoe. All intellectual
        property rights are reserved. You may access this from Ekoe for your own
        personal use subjected to restrictions set in these terms and
        conditions.
      </p>

      <p className="mb-2">You must not:</p>
      <ul className="flex flex-col gap-3 list-disc ml-3 md:ml-10">
        <li>Republish material from Ekoe</li>
        <li>Sell, rent or sub-license material from Ekoe</li>
        <li>Reproduce, duplicate or copy material from Ekoe</li>
        <li>Redistribute content from Ekoe</li>
      </ul>
      ...
      <p className="mb-2">
        ...
        exchange opinions and information in certain areas of the website. Ekoe
        Clothing does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Ekoe Clothing,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Ekoe Clothing shall not be
      ...
      <p className="mb-2">
        Ekoe Clothing reserves the right to monitor all Comments and to remove
      ...
      <p className="mb-2">
        You hereby grant Ekoe Clothing a non-exclusive license to use,
      ...
      <p className="mb-2">
        ...
        the hyperlink compensates the absence of Ekoe Clothing; and (d) the link
      ...
      <p className="mb-2">
        ...
        e-mail to Ekoe Clothing. Please include your name, your organization
      ...
      <p className="mb-2">
        No use of Ekoe Clothing&apos;s logo or other artwork will be allowed for
        linking absent a trademark license agreement.
      </p>

      <h3 className="text-center text-lg font-bold">iFrames</h3>
      ...
      <h3 className="text-center text-lg font-bold">Content Liability</h3>
      ...
      <h3 className="text-center text-lg font-bold">Reservation of Rights</h3>
      ...
      <h3 className="text-center text-lg font-bold">Disclaimer</h3>
